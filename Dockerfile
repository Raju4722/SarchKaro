...
<<<<<<< HEAD
COPY /app/build/libs/SarchKaro-0.0.1-SNAPSHOT.jar /app/SarchKaro-0.0.1-SNAPSHOT.jar
=======
COPY build/libs/SarchKaro-0.0.1-SNAPSHOT.jar /app/Sarchkaro.jar
>>>>>>> e977e767874a9ea99751bc06224ebb718dcf1b3f

# Expose the application port (default 8080 for Spring Boot)
EXPOSE 8080

# Run the application
ENTRYPOINT ["java", "-jar", "/app/SarchKaro-0.0.1-SNAPSHOT.jar"]
